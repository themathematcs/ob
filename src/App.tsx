...
import { INITIAL_CLIENTS, ClientMonitor } from './types';
...
export default function App() {
  const [clients, setClients] = useState<ClientMonitor[]>(INITIAL_CLIENTS);
          ...
          <div className="max-w-[1520px] mx-auto flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-[#8f7ec4] border-l border-[#37216a] pl-3">
                {clients.filter((c) => c.status === 'ONLINE').length} Online • 1 Offline
              </span>
            </div>
